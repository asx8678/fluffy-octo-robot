...
from code_muse.tools.mitmproxy.proxy_manager import get_manager
        ...
        if command == "start":
            ...
            if data and isinstance(data, dict):
                ...
                with open(fd, "w", encoding="utf-8") as f:
                    f.write(
                        json.dumps(
                            data, option=orjson.OPT_INDENT_2, default=str
                        ).decode()
                    )
...
from code_muse.tools.mitmproxy.register_callbacks import (  # noqa: E402
