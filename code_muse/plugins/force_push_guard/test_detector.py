...
class TestDetectForcePush:
    ...
    def test_plus_refspec_head(self) -> None:
        result = detect_force_push("git push origin +HEAD:refs/heads/main")
        assert result is not None
        assert result.pattern_name == "+refspec"

    def test_force_before_remote(self) -> None:
    ...
    def test_force_after_remote(self) -> None:
        result = detect_force_push("git push origin feature --force")
        assert result is not None
        assert result.pattern_name == "--force"

    def test_force_flag_with_equals(self) -> None:
        result = detect_force_push("git push --force=yes origin main")
        assert result is not None
        assert result.pattern_name == "--force"

    def test_force_with_other_flags(self) -> None:
    ...
    def test_push_with_tags(self) -> None:
        assert detect_force_push("git push origin --tags") is None

    def test_push_u(self) -> None:
    ...
    def test_git_push_all(self) -> None:
        assert detect_force_push("git push --all origin") is None

    def test_git_push_mirror(self) -> None:
    ...
    def test_push_no_force_file(self) -> None:
    ...
    def test_compound_and_normal_push(self) -> None:
