...
Historically, code_muse used a local static catalog. We now source skills from
`remote_catalog.fetch_remote_catalog()` while keeping the same access patterns.

Public API:
    from code_muse.plugins.agent_skills.skill_catalog import (
        SkillCatalog,
        SkillCatalogEntry,
...
from code_muse.plugins.agent_skills.remote_catalog import fetch_remote_catalog
...
class SkillCatalog:
    ...
    def get_by_id(self, skill_id: str) -> SkillCatalogEntry | None:
