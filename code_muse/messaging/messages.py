"""Structured message models for Muse's messaging system.
...
class SubAgentStatusMessage(BaseMessage):
    ...
    agent_name: str = Field(description="Name of the agent (e.g., 'muse')")
...
class SkillDeactivateMessage(BaseMessage):
    """Result of deactivating a skill."""

    category: MessageCategory = MessageCategory.TOOL_OUTPUT
    skill_name: str = Field(description="Name of the deactivated skill")
    success: bool = Field(default=True, description="Whether deactivation succeeded")
    message: str = Field(default="", description="Status message")


class SkillBackgroundMessage(BaseMessage):
    """Status update for a background skill job."""

    category: MessageCategory = MessageCategory.TOOL_OUTPUT
    job_id: str = Field(description="Unique job identifier")
    skill_name: str = Field(description="Name of the skill running in background")
    status: str = Field(description="Current job status")
    result: str = Field(default="", description="Job result or output preview")
    log_file: str = Field(default="", description="Path to the log file")
