"""Extended tests for code_muse.tools.command_runner - filling coverage gaps.
...
spec = importlib.util.spec_from_file_location(
    ...
    Path(__file__).parent.parent.parent / "code_muse" / "tools" / "command_runner.py",
)
...
class TestRunShellCommandAsync:
    ...
    def test_run_shell_command_blocked_by_callback(self):
        ...
        with patch(
            "code_muse.callbacks.on_run_shell_command", new_callable=AsyncMock
        ) as mock_callback:
...
class TestReasoningOutput:
    ...
    def test_share_your_reasoning_basic(self, monkeypatch):
        ...
        with patch(
            "code_muse.tools.command_runner.get_message_bus", return_value=mock_bus
        ):
...
class TestRegisterAgentRunShellCommand:
    ...
    def test_register_agent_run_shell_command(self, monkeypatch):
        ...
        from code_muse.tools.command_runner import register_agent_run_shell_command
