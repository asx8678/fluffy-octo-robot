...
from code_muse.tools.ask_user_question.theme import (
    RichColors,
    TUIColors,
...
class TestGetConfigValue:
    ...
    def test_import_error_returns_none(self):
        import code_muse.tools.ask_user_question.theme as theme_mod

        # Reset cached getter
        old = theme_mod._config_getter
        theme_mod._config_getter = None
        try:
            with patch.dict("sys.modules", {"code_muse.config": None}):
    ...
    def test_uses_config_get_value(self):
        ...
        try:
            ...
            with patch("code_muse.tools.ask_user_question.theme._config_getter", None):
                with patch("code_muse.config.get_value", mock_get):
                    theme_mod._config_getter = None
...
class TestApplyConfigOverrides:
    ...
    def test_no_overrides_returns_default(self):
        default = TUIColors()
        with patch(
            "code_muse.tools.ask_user_question.theme._get_config_value",
            return_value=None,
        ):
