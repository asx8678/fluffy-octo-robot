"""Tests targeting remaining uncovered lines in code_muse/tools/ask_user_question/."""
...
def test_is_interactive_non_tty():
    ...
    from code_muse.tools.ask_user_question.handler import is_interactive
...
def test_ask_user_question_validation_error():
    ...
    from code_muse.tools.ask_user_question.handler import ask_user_question
...
def test_ask_user_question_type_error():
    ...
    with patch(
        "code_muse.tools.ask_user_question.handler._validate_input",
...
def _mock_interactive(fn):
    ...
    return patch(
        "code_muse.tools.ask_user_question.handler.is_interactive", return_value=True
    )(fn)
...
def test_ask_user_question_timeout(_):
    ...
    from code_muse.tools.ask_user_question.handler import ask_user_question
    from code_muse.tools.ask_user_question.models import (
    ...
    with (
        ...
        patch(
            "code_muse.tools.ask_user_question.handler._run_interactive_picker",
...
def test_async_context_error_is_runtime_error():
    ...
    from code_muse.tools.ask_user_question.handler import AsyncContextError
...
def test_format_validation_error():
    ...
    from code_muse.tools.ask_user_question.handler import _format_validation_error
...
def test_format_validation_error_many():
    ...
    from code_muse.tools.ask_user_question.handler import (
...
def test_sanitizer_none_not_allowed():
    ...
    from code_muse.tools.ask_user_question.models import _make_sanitizer
...
def test_register_ask_user_question():
    ...
    from code_muse.tools.ask_user_question.registration import (
...
def test_question_ui_state_is_question_answered():
    ...
    from code_muse.tools.ask_user_question.models import Question, QuestionOption
    from code_muse.tools.ask_user_question.terminal_ui import QuestionUIState
...
def test_demo_tui_main():
    ...
    from code_muse.tools.ask_user_question import demo_tui
...
def test_tui_loop_module_import():
    ...
    from code_muse.tools.ask_user_question import tui_loop
