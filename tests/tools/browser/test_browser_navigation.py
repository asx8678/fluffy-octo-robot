...
class TestNavigateToUrl:
    ...
    async def test_navigate_to_url_success(self):
        ...
        with (
            patch(
                "code_muse.tools.browser.browser_navigation.get_session_browser_manager",
                return_value=mock_manager,
            ),
            patch("code_muse.tools.browser.browser_navigation.emit_info"),
            patch(
                "code_muse.tools.browser.browser_navigation.emit_success"
    ...
    async def test_navigate_with_redirect(self):
        ...
        with (
            ...
            with patch("code_muse.tools.browser.browser_navigation.emit_success"):
                result = await navigate_to_url("https://example.com")
    ...
    async def test_navigate_timeout_error(self):
        ...
        with (
            ...
            with patch("code_muse.tools.browser.browser_navigation.emit_error"):
