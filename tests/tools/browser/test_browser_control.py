...
class TestBrowserInitialization:
    ...
    async def test_initialize_browser_default_settings(self):
        ...
        with (
            patch(
                "code_muse.tools.browser.browser_control.get_session_browser_manager",
                return_value=mock_manager,
            ),
            patch(
                "code_muse.tools.browser.browser_control.emit_info"
            ) as mock_emit_info,
        ):
            with patch("code_muse.tools.browser.browser_control.emit_error"):
    ...
    async def test_initialize_browser_headless_mode(self):
        ...
        with (
            ...
            patch("code_muse.tools.browser.browser_control.emit_info"),
        ):
    ...
    async def test_initialize_browser_initialization_error(self):
        ...
        with (
            ...
            patch("code_muse.tools.browser.browser_control.emit_info"),
            patch(
                "code_muse.tools.browser.browser_control.emit_error"
            ) as mock_emit_error,
        ):
            result = await initialize_browser()
...
class TestBrowserClosing:
    ...
    async def test_close_browser_success(self):
        ...
        with (
            ...
            patch("code_muse.tools.browser.browser_control.emit_info"),
            patch(
                "code_muse.tools.browser.browser_control.emit_warning"
    ...
    async def test_close_browser_cleanup_called(self):
        ...
        with (
            ...
            with patch("code_muse.tools.browser.browser_control.emit_warning"):
                await close_browser()
