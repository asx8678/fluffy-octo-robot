...
def _patch_control(target, **kwargs):
    return patch(f"code_muse.tools.browser.browser_control.{target}", **kwargs)
...
def _suppress_emit():
    with (
        ...
        patch("code_muse.tools.browser.browser_control.emit_error"),
        patch("code_muse.tools.browser.browser_control.emit_success"),
        patch("code_muse.tools.browser.browser_control.emit_warning"),
    ):
        yield
