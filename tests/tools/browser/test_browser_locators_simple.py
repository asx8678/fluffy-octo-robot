...
from code_muse.tools.browser.browser_locators import find_by_role
...
async def test_find_by_role_basic():
    ...
    with (
        patch(
            "code_muse.tools.browser.browser_locators.get_session_browser_manager",
            return_value=mock_manager,
        ),
        patch("code_muse.tools.browser.browser_locators.emit_info"),
