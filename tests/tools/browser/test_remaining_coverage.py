...
MOD_MGR = "code_muse.tools.browser.browser_manager"
...
class TestBrowserManagerRemainingLines:
    ...
    async def test_cleanup_exception_branch(self):
        ...
        import code_muse.tools.browser.browser_manager as bm_mod
        from code_muse.tools.browser.browser_manager import BrowserManager
    ...
    def test_atexit_cleanup_no_running_loop(self):
        ...
        import code_muse.tools.browser.browser_manager as bm_mod
        from code_muse.tools.browser.browser_manager import _sync_cleanup_browsers
...
MOD_SCRIPTS = "code_muse.tools.browser.browser_scripts"
...
class TestBrowserScriptsRemainingLines:
    ...
    async def test_scroll_to_element_no_page(self):
        ...
        from code_muse.tools.browser.browser_scripts import scroll_to_element
...
MOD_WF = "code_muse.tools.browser.browser_workflows"
...
class TestBrowserWorkflowsRemainingLines:
    ...
    async def test_list_workflows_file_error(self, tmp_path):
        ...
        from code_muse.tools.browser.browser_workflows import list_workflows
