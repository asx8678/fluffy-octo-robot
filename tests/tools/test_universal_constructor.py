"""Tests for code_muse/tools/universal_constructor.py - 100% coverage."""
...
class TestHelpers:
    def test_stub_not_implemented(self):
        from code_muse.tools.universal_constructor import _stub_not_implemented
    ...
    def test_run_ruff_format_success(self):
        from code_muse.tools.universal_constructor import _run_ruff_format
    ...
    def test_generate_preview_short(self):
        from code_muse.tools.universal_constructor import _generate_preview
    ...
    def test_build_summary_error(self):
        from code_muse.tools.universal_constructor import (
    ...
    def test_build_summary_list(self):
        from code_muse.plugins.universal_constructor.models import UCListOutput
        from code_muse.tools.universal_constructor import (
            UniversalConstructorOutput,
            _build_summary,
        )
    ...
    def test_build_summary_call(self):
        from code_muse.plugins.universal_constructor.models import UCCallOutput
        from code_muse.tools.universal_constructor import (
            UniversalConstructorOutput,
            _build_summary,
        )
    ...
    def test_build_summary_create(self):
        from code_muse.plugins.universal_constructor.models import UCCreateOutput
        from code_muse.tools.universal_constructor import (
            UniversalConstructorOutput,
            _build_summary,
        )
    ...
    def test_build_summary_update(self):
        from code_muse.plugins.universal_constructor.models import UCUpdateOutput
        from code_muse.tools.universal_constructor import (
            UniversalConstructorOutput,
            _build_summary,
        )
...
class TestUniversalConstructorImpl:
    ...
    async def test_unknown_action(self):
        from code_muse.tools.universal_constructor import universal_constructor_impl

        ctx = MagicMock()
        with patch("code_muse.tools.universal_constructor._emit_uc_message"):
            r = await universal_constructor_impl(ctx, "unknown")
        assert not r.success
        assert "Unknown action" in r.error

    @pytest.mark.asyncio
    @patch("code_muse.tools.universal_constructor._emit_uc_message")
    @patch("code_muse.tools.universal_constructor._handle_list_action")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.universal_constructor._emit_uc_message")
    @patch("code_muse.tools.universal_constructor._handle_call_action")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.universal_constructor._emit_uc_message")
    @patch("code_muse.tools.universal_constructor._handle_create_action")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.universal_constructor._emit_uc_message")
    @patch("code_muse.tools.universal_constructor._handle_update_action")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.universal_constructor._emit_uc_message")
    @patch("code_muse.tools.universal_constructor._handle_info_action")
...
class TestHandleListAction:
    def test_success(self):
        ...
        from code_muse.tools.universal_constructor import _handle_list_action
...
class TestHandleCallAction:
    def test_no_tool_name(self):
        from code_muse.tools.universal_constructor import _handle_call_action
    ...
    def test_success(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.runner.run_tool_subprocess",
    ...
    def test_with_source_preview(self):
        ...
        with (
            ...
            patch("pathlib.Path.read_text", return_value="def f(): pass"),
            patch(
                "code_muse.plugins.universal_constructor.runner.run_tool_subprocess",
...
class TestHandleCreateAction:
    def test_no_code(self):
        from code_muse.tools.universal_constructor import _handle_create_action
    ...
    def test_syntax_error(self):
        ...
        with patch(
            "code_muse.plugins.universal_constructor.sandbox.validate_syntax"
        ) as mock_val:
    ...
    def test_no_functions(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.sandbox.extract_function_info"
            ) as mock_ext,
        ):
    ...
    def test_no_name(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.sandbox._extract_tool_meta",
                return_value=None,
            ),
        ):
            mock_val.return_value = MagicMock(valid=True)
    ...
    def test_meta_validation_error(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.sandbox._validate_tool_meta",
    ...
    def test_write_error(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.sandbox.check_dangerous_patterns"
            ) as mock_safe,
    ...
    def test_success_with_namespace(self, tmp_path):
        ...
        with (
            ...
            patch("code_muse.plugins.universal_constructor.USER_UC_DIR", tmp_path),
            patch(
                "code_muse.tools.universal_constructor._run_ruff_format",
                return_value=None,
            ),
            patch("code_muse.plugins.universal_constructor.registry.get_registry"),
        ):
            mock_val.return_value = MagicMock(valid=True)
            mock_ext.return_value = MagicMock(functions=[func], warnings=[])
            mock_safe.return_value = MagicMock(warnings=[])
...
class TestHandleUpdateAction:
    def test_no_tool_name(self):
        from code_muse.tools.universal_constructor import _handle_update_action
    ...
    def test_no_tool_meta(self, tmp_path):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.safety.is_path_within_uc_dir",
                return_value=True,
            ),
        ):
            mock_val.return_value = MagicMock(valid=True)
...
class TestHandleInfoAction:
    def test_no_tool_name(self):
        from code_muse.tools.universal_constructor import _handle_info_action
...
class TestImplRegistration:
    ...
    async def test_registered_tool_calls_impl(self):
        ...
        ctx = MagicMock()
        with patch(
            "code_muse.tools.universal_constructor.universal_constructor_impl"
        ) as mock_impl:
            from code_muse.tools.universal_constructor import (
                UniversalConstructorOutput,
            )
