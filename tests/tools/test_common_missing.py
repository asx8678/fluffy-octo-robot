"""Tests for remaining coverage gaps in code_muse/tools/common.py."""
...
class TestPygmentsImportFallback:
    def test_pygments_available(self):
        from code_muse.tools.common import PYGMENTS_AVAILABLE
...
class TestGetUserApproval:
    ...
    @patch("code_muse.tools.common.arrow_select", return_value="\u2713 Approve")
    ...
    @patch("code_muse.tools.common.arrow_select", return_value="\u2717 Reject")
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    @patch("time.sleep")
    ...
    @patch("code_muse.tools.common.Prompt")
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    @patch("time.sleep")
    ...
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.common.emit_error")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    @patch("time.sleep")
...
class TestGetUserApprovalAsync:
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.common.arrow_select_async", return_value="\u2713 Approve")
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    @patch("time.sleep")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.common.arrow_select_async", return_value="\u2717 Reject")
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    @patch("time.sleep")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.common.arrow_select_async", return_value="feedback")
    @patch("code_muse.tools.common.Prompt")
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
    ...
    @pytest.mark.asyncio
    @patch("code_muse.tools.common.arrow_select_async", side_effect=KeyboardInterrupt)
    @patch("code_muse.tools.common.Console")
    @patch("code_muse.tools.common.emit_info")
    @patch("code_muse.tools.common.emit_error")
    @patch("code_muse.tools.command_runner.set_awaiting_user_input")
