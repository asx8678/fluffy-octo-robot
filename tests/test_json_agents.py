...
class TestJSONAgentDiscovery:
    ...
    def test_discover_json_agents(self, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            monkeypatch.setattr(
                "code_muse.config.get_user_agents_directory", lambda: temp_dir
            )
            # Change to temp directory to avoid finding project .muse
    ...
    def test_get_user_agents_directory(self):
        ...
        # Should contain muse (legacy .muse or XDG muse)
        assert "muse" in user_dir
