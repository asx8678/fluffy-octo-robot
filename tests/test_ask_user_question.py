...
class TestAskUserQuestion:
    def test_subagent_blocked(self):
        with patch(
            "code_muse.tools.ask_user_question.handler.is_subagent", return_value=True
        ):
    ...
    def test_wiggum_blocked(self):
        with (
            patch(
                "code_muse.tools.ask_user_question.handler.is_subagent",
                return_value=False,
            ),
            patch(
                "code_muse.tools.ask_user_question.handler.is_wiggum_active",
                return_value=True,
            ),
        ):
            result = ask_user_question(
    ...
    def test_non_interactive(self):
        with (
            ...
            patch(
                "code_muse.tools.ask_user_question.handler.is_interactive",
                return_value=False,
            ),
        ):
            result = ask_user_question(
    ...
    def test_success(self):
        from code_muse.tools.ask_user_question.models import QuestionAnswer
