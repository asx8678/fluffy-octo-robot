...
class TestSummarizationAgent:
    ...
    def test_ensure_thread_pool_creates_new(self):
        ...
        import code_muse.summarization_agent

        code_muse.summarization_agent._thread_pool = None
    ...
    def test_ensure_thread_pool_reuses_existing(self):
        ...
        code_muse.summarization_agent._thread_pool = original_pool
    ...
    def test_reload_summarization_agent_basic(self, mock_model, mock_models_config):
        ...
        with (
            patch(
                "code_muse.summarization_agent.ModelFactory.load_config"
            ) as mock_load_config,
            patch(
                "code_muse.summarization_agent.ModelFactory.get_model"
            ) as mock_get_model,
            patch(
                "code_muse.summarization_agent.get_summarization_model_name"
            ) as mock_get_name,
            patch("code_muse.summarization_agent.Agent") as mock_agent_class,
        ):
    ...
    def test_get_summarization_agent_force_reload(self, mock_model, mock_models_config):
        ...
        with patch(
            "code_muse.summarization_agent.reload_summarization_agent"
        ) as mock_reload:
            ...
            code_muse.summarization_agent._summarization_agent = None
    ...
    def test_get_summarization_agent_no_reload(self, mock_model):
        ...
        # Set cached agent
        code_muse.summarization_agent._summarization_agent = mock_model
    ...
    def test_get_summarization_agent_existing_cached(self):
        ...
        code_muse.summarization_agent._summarization_agent = cached_agent
...
class TestRunSummarizationSync:
    ...
    def test_run_summarization_sync_no_event_loop(self, mock_sync_result):
        ...
        with (
            patch(
                "code_muse.summarization_agent.get_summarization_agent"
            ) as mock_get_agent,
            patch("code_muse.summarization_agent._ensure_thread_pool") as mock_pool,
        ):
            mock_agent = MagicMock()
    ...
    def test_run_summarization_sync_thread_pool_error_handling(self):
        ...
        with (
            ...
            patch(
                "code_muse.summarization_agent.asyncio.get_running_loop"
            ) as mock_get_loop,
            patch("code_muse.summarization_agent._ensure_thread_pool") as mock_pool,
        ):
...
class TestSummarizationAgentEdgeCases:
    ...
    def test_agent_creation_model_failure(self):
        ...
        with (
            ...
            patch("code_muse.summarization_agent.ModelFactory.get_model"),
            patch("code_muse.summarization_agent.get_summarization_model_name"),
        ):
    ...
    def test_agent_creation_model_name_failure(self):
        ...
        with (
            patch("code_muse.summarization_agent.ModelFactory.load_config"),
            patch("code_muse.summarization_agent.ModelFactory.get_model"),
            patch(
                "code_muse.summarization_agent.get_summarization_model_name"
            ) as mock_get_name,
    ...
    def test_thread_pool_cleanup(self):
        ...
        # Verify it exists
        assert code_muse.summarization_agent._thread_pool is not None
    ...
    def test_concurrent_agent_access(self):
        ...
        with (
            ...
            for _worker_id, _i, agent_type in results:
    ...
    def test_reload_state_consistency(self):
        ...
        # Clear initial state
        code_muse.summarization_agent._summarization_agent = None
        code_muse.summarization_agent._reload_count = 0
