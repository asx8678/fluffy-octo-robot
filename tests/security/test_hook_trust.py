...
from code_muse.hook_engine.executor import execute_hook
from code_muse.hook_engine.models import EventData, HookConfig
from code_muse.hook_engine.trust import (
    _load_trust_db,
    approve_hook,
...
class TestHookOutputCapping:
    ...
    def test_executor_caps_output(self):
        ...
        from code_muse.hook_engine.executor import _MAX_HOOK_STDERR, _MAX_HOOK_STDOUT
...
class TestHookConfigLoaderTrust:
    ...
    def test_load_hooks_config_with_sources_returns_tuple(self):
        from code_muse.plugins.claude_code_hooks.config import (
