...
class TestLoadPluginTools:
    ...
    def test_load_plugin_tools_with_result(self):
        ...
        mock_fn = MagicMock()
        with patch(
            "code_muse.tools.on_register_tools",
    ...
    def test_load_plugin_tools_none_result(self):
        ...
        with patch("code_muse.tools.on_register_tools", return_value=[None]):
            _load_plugin_tools()
    ...
    def test_load_plugin_tools_invalid_tool_def(self):
        ...
        with patch(
            "code_muse.tools.on_register_tools", return_value=[[{"invalid": True}]]
        ):
            _load_plugin_tools()  # Should not crash
...
class TestHasExtendedThinkingActive:
    def test_none_model(self):
        ...
        with patch("code_muse.config.get_global_model_name", return_value=None):
    ...
    def test_anthropic_model_enabled(self):
        ...
        with (
            ...
            patch(
                "code_muse.model_utils.get_default_extended_thinking",
                return_value=False,
            ),
        ):
...
class TestRegisterToolsForAgent:
    ...
    def test_register_unknown_tool(self):
        ...
        agent = MagicMock()
        with patch("code_muse.tools.emit_warning"):
    ...
    def test_skip_uc_when_disabled(self):
        ...
        agent = MagicMock()
        with patch(
            "code_muse.config.get_universal_constructor_enabled", return_value=False
        ):
    ...
    def test_skip_removed_reasoning_tool(self):
        ...
        agent = MagicMock()
        with (
            patch("code_muse.tools.emit_warning") as mock_warn,
            patch(
                "code_muse.config.get_universal_constructor_enabled", return_value=True
            ),
        ):
