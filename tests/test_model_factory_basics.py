...
class TestModelFactoryBasics:
    ...
    def test_load_config_with_extra_models(
        ...
        mock_main_path.exists.return_value = True  # bundled models.json exists
        mock_user_path.exists.return_value = False  # user models.json does not exist
        ...
        def path_side_effect(path_arg):
            ...
            elif ".muse" in path_str and "models.json" in path_str:
                return mock_user_path
            elif (
