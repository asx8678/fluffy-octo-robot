"""Tests for code_muse.plugins package __init__.py.
...
class TestLoadPluginCallbacks:
    ...
    def test_load_plugin_callbacks_callable(self):
        ...
        from code_muse.plugins import load_plugin_callbacks
    ...
    def test_import_error_is_caught(self, mock_import):
        ...
        with patch("code_muse.plugins.Path") as mock_path_class:
