"""Comprehensive tests for code_muse/messaging/subagent_console.py.
...
from code_muse.messaging.subagent_console import (
    DEFAULT_STYLE,
    STATUS_STYLES,
    AgentState,
...
class TestDisplayManagement:
    ...
    @patch("code_muse.messaging.subagent_console.Live")
...
class TestContextManager:
    ...
    def test_context_manager_exit_on_exception(self, mock_stop):
        ...
        with pytest.raises(ValueError), manager:
