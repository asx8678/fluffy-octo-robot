...
from code_muse.error_logging import (
    get_log_file_path,
    get_logs_dir,
    log_error,
    log_error_message,
...
class TestErrorLogging:
    ...
    def test_get_log_file_path_returns_path(self):
        ...
        assert str(log_path).endswith("errors.log")
    ...
    def test_ensure_logs_dir_creates_directory(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("code_muse.error_logging.LOGS_DIR", test_logs_dir):
                from code_muse import error_logging
    ...
    def test_log_error_writes_to_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            test_logs_dir = Path(tmpdir) / "logs"
            test_log_file = test_logs_dir / "errors.log"
