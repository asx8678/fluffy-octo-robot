...
Implementation targets:
  code_muse/hook_engine/aliases.py
  code_muse/hook_engine/matcher.py  (alias integration)
  code_muse/hook_engine/executor.py
  code_muse/hook_engine/registry.py
  code_muse/hook_engine/engine.py
  code_muse/hook_engine/__init__.py
"""
...
from code_muse.hook_engine import EventData, HookConfig, HookEngine
from code_muse.hook_engine.engine import validate_config_file
from code_muse.hook_engine.executor import (
    _build_environment,
...
from code_muse.hook_engine.matcher import matches
from code_muse.hook_engine.models import ExecutionResult
from code_muse.hook_engine.registry import (
...
class TestCrossProviderMatching:
    ...
    correctly when code_muse calls the equivalent internal tool
