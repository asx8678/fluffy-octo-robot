"""Tests for code_muse/messaging/spinner/__init__.py module.
...
from code_muse.messaging.spinner import (
    _active_spinners,
...
class TestPauseAllSpinners:
    ...
    @patch("code_muse.tools.subagent_context.is_subagent", return_value=False)
    ...
    @patch("code_muse.tools.subagent_context.is_subagent", return_value=True)
