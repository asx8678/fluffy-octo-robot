...
from code_muse.messaging.message_queue import (
    MessageQueue,
    MessageType,
    UIMessage,
...
class TestGlobalQueueFunctions:
    ...
    def test_get_global_queue_creates_queue(self):
        ...
        import code_muse.messaging.message_queue as mq_module
...
class TestEmitPrompt:
    ...
    def test_emit_prompt(self):
        ...
        with patch(
            "code_muse.command_line.utils.safe_input", return_value="user input"
        ) as mock_input:
            from code_muse.messaging.message_queue import emit_prompt
