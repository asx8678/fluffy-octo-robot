"""Tests for code_muse.messaging.queue_console."""
...
from code_muse.messaging.message_queue import MessageQueue, MessageType
from code_muse.messaging.queue_console import QueueConsole, get_queue_console
