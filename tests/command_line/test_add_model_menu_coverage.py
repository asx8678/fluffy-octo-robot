...
from code_muse.command_line.add_model_menu import (
    AddModelMenu,
...
def _make_menu_with_providers(providers=None, models=None):
    ...
    with patch("code_muse.command_line.add_model_menu.ModelsDevRegistry") as mock_cls:
        mock_reg = MagicMock()
...
class TestAddModelToExtraConfig:
    ...
    def test_add_model_write_error(self):
        ...
        p = _make_provider()
        with patch(
            "code_muse.command_line.add_model_menu.EXTRA_MODELS_FILE",
...
class TestNavigationMethods:
    def test_enter_provider(self):
        ...
        models = [_make_model()]
        with patch(
            "code_muse.command_line.add_model_menu.ModelsDevRegistry"
        ) as mock_cls:
            mock_reg = MagicMock()
...
class TestInitializeRegistryErrors:
    @patch("code_muse.command_line.add_model_menu.ModelsDevRegistry")
