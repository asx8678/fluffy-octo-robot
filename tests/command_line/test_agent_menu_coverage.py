...
class TestSanitizeDisplayText:
    ...
    def test_strips_emojis(self):
        result = _sanitize_display_text("Muse \U0001f436")
...
class TestGetPinnedModel:
    @patch(
        "code_muse.command_line.agent_menu.get_agent_pinned_model",
        return_value="gpt-4",
    )
    ...
    @patch(
        "code_muse.command_line.agent_menu.get_agent_pinned_model", return_value=None
    )
    ...
    def test_exception_in_builtin(self, mock_pin):
        with patch(
            "code_muse.agents.json_agent.discover_json_agents", side_effect=Exception
        ):
            assert _get_pinned_model("agent1") is None
...
class TestSelectPinnedModel:
    @pytest.mark.asyncio
    @patch("code_muse.command_line.agent_menu.arrow_select_async")
    @patch(
        "code_muse.command_line.agent_menu.load_model_names", return_value=["m1", "m2"]
    )
    @patch(
        "code_muse.command_line.agent_menu.get_agent_pinned_model", return_value=None
    )
    ...
    @pytest.mark.asyncio
    @patch(
        "code_muse.command_line.agent_menu.arrow_select_async",
        side_effect=KeyboardInterrupt,
    )
    @patch("code_muse.command_line.agent_menu.load_model_names", return_value=["m1"])
    @patch(
        "code_muse.command_line.agent_menu.get_agent_pinned_model", return_value=None
    )
    ...
    @pytest.mark.asyncio
    @patch(
        "code_muse.command_line.agent_menu.load_model_names",
    ...
    @pytest.mark.asyncio
    @patch("code_muse.command_line.agent_menu.load_model_names", return_value=[])
    @patch(
        "code_muse.command_line.agent_menu.get_agent_pinned_model", return_value=None
    )
...
class TestReloadAgentIfCurrent:
    @patch("code_muse.command_line.agent_menu.get_current_agent")
    ...
    @patch("code_muse.command_line.agent_menu.emit_info")
    @patch("code_muse.command_line.agent_menu.get_current_agent")
    ...
    @patch("code_muse.command_line.agent_menu.emit_warning")
    @patch("code_muse.command_line.agent_menu.get_current_agent")
...
class TestApplyPinnedModel:
    @patch("code_muse.command_line.agent_menu._reload_agent_if_current")
    @patch("code_muse.command_line.agent_menu.emit_success")
    @patch("code_muse.command_line.agent_menu.set_agent_pinned_model")
    @patch("code_muse.agents.json_agent.discover_json_agents", return_value={})
    ...
    @patch("code_muse.command_line.agent_menu._reload_agent_if_current")
    @patch("code_muse.command_line.agent_menu.emit_success")
    @patch("code_muse.command_line.agent_menu.clear_agent_pinned_model")
    @patch("code_muse.agents.json_agent.discover_json_agents", return_value={})
    ...
    @patch(
        "code_muse.command_line.agent_menu.set_agent_pinned_model",
        side_effect=Exception("fail"),
    )
...
class TestGetAgentEntries:
    @patch(
        "code_muse.command_line.agent_menu.get_agent_descriptions",
        return_value={"a": "Desc A", "b": "Desc B"},
    )
    @patch(
        "code_muse.command_line.agent_menu.get_available_agents",
    ...
    @patch("code_muse.command_line.agent_menu.get_agent_descriptions", return_value={})
    @patch(
        "code_muse.command_line.agent_menu.get_available_agents",
        return_value={"a": "A"},
    )
...
class TestRenderMenuPanel:
    @patch("code_muse.command_line.agent_menu._get_pinned_model", return_value=None)
    ...
    @patch("code_muse.command_line.agent_menu._get_pinned_model", return_value="gpt-4")
...
class TestInteractiveAgentPicker:
    ...
    @patch("code_muse.command_line.agent_menu.get_current_agent")
    @patch("code_muse.command_line.agent_menu.get_agent_descriptions", return_value={})
    @patch("code_muse.command_line.agent_menu.get_available_agents", return_value={})
    ...
    @patch("code_muse.command_line.agent_menu.emit_info")
    @patch("code_muse.command_line.agent_menu.Application")
    @patch("sys.stdout")
