...
class TestGetClipboardManager:
    ...
    def test_singleton_thread_safe_creation(self):
        ...
        from code_muse.command_line import clipboard
...
class TestCaptureClipboardImageToPending:
    ...
    def test_returns_none_when_no_image(self):
        ...
        with patch(
            "code_muse.command_line.clipboard.get_clipboard_image", return_value=None
        ):
    ...
    def test_returns_placeholder_when_image_captured(self):
        ...
        with patch(
            "code_muse.command_line.clipboard.get_clipboard_image",
...
class TestHasImageInClipboard:
    ...
    def test_returns_true_when_image_present(self):
        ...
        with (
            ...
            patch("code_muse.command_line.clipboard.sys.platform", "darwin"),
            patch("code_muse.command_line.clipboard.ImageGrab") as mock_grab,
            patch("code_muse.command_line.clipboard.Image") as mock_image_module,
        ):
...
class TestImageResizing:
    ...
    def test_resize_not_needed_for_small_image(self):
        ...
        with patch("code_muse.command_line.clipboard.Image") as mock_image_module:
            mock_image_module.Image = type(mock_image)
...
class TestSafeOpenImageEdgeCases:
    ...
    def test_decompression_bomb_error(self):
        ...
        with patch("code_muse.command_line.clipboard.Image") as mock_img:
...
class TestResizeImageEdgeCases:
    ...
    def test_returns_image_when_image_module_is_none(self):
        ...
        mock_img = MagicMock()
        with patch("code_muse.command_line.clipboard.Image", None):
    ...
    def test_caps_height_dimension(self):
        ...
        with patch("code_muse.command_line.clipboard.Image") as mock_img_mod:
...
class TestGetClipboardImageLinux:
    ...
    def test_linux_small_image_verification_fails(self):
        ...
        with (
            ...
            patch("code_muse.command_line.clipboard.PIL_AVAILABLE", True),
            patch(
                "code_muse.command_line.clipboard._safe_open_image", return_value=None
            ),
        ):
            assert get_clipboard_image() is None
...
class TestMaxImageSizeConstant:
    ...
    def test_max_size_is_10mb(self):
        ...
        from code_muse.command_line.clipboard import MAX_IMAGE_SIZE_BYTES

        assert MAX_IMAGE_SIZE_BYTES == 10 * 1024 * 1024

    def test_max_dimension_is_4096(self):
        """Test that max dimension is 4096."""
        from code_muse.command_line.clipboard import MAX_IMAGE_DIMENSION
...
class TestPILAvailableFlag:
    ...
    def test_pil_available_is_bool(self):
        ...
        from code_muse.command_line.clipboard import PIL_AVAILABLE
    ...
    def test_binary_content_available_is_bool(self):
        ...
        from code_muse.command_line.clipboard import BINARY_CONTENT_AVAILABLE
...
class TestSecurityFeatures:
    ...
    def test_max_pending_images_constant_exists(self):
        ...
        from code_muse.command_line.clipboard import MAX_PENDING_IMAGES
    ...
    def test_rate_limit_constant_exists(self):
        ...
        from code_muse.command_line.clipboard import CLIPBOARD_RATE_LIMIT_SECONDS
    ...
    def test_add_image_raises_when_limit_exceeded(self):
        ...
        for _i in range(MAX_PENDING_IMAGES):
            manager.add_image(fake_png)
