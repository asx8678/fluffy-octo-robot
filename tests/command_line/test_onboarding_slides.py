"""Tests for code_muse/command_line/onboarding_slides.py"""

MODULE = "code_muse.command_line.onboarding_slides"


class TestModelOptions:
    def test_model_options_is_list(self):
        from code_muse.command_line.onboarding_slides import MODEL_OPTIONS
...
class TestGetNavFooter:
    def test_returns_string(self):
        from code_muse.command_line.onboarding_slides import get_nav_footer
...
class TestSlideWelcome:
    def test_returns_string(self):
        from code_muse.command_line.onboarding_slides import slide_welcome
...
class TestSlideModels:
    def test_with_options(self):
        from code_muse.command_line.onboarding_slides import slide_models
...
class TestSlideUseCases:
    def test_returns_string(self):
        from code_muse.command_line.onboarding_slides import slide_use_cases
...
class TestSlideDone:
    def test_without_oauth(self):
        from code_muse.command_line.onboarding_slides import slide_done
