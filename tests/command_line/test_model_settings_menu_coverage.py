...
def _make_menu(models=None, current="gpt-5", supported_settings=None):
    ...
    with (
        ...
        patch(
            "code_muse.command_line.model_settings_menu.get_global_model_name",
...
class TestLoadAllModelNames:
    @patch("code_muse.command_line.model_settings_menu.ModelFactory")
...
class TestModelSettings:
    @patch("code_muse.command_line.model_settings_menu.model_supports_setting")
    ...
    @patch(
        "code_muse.command_line.model_settings_menu.get_openai_verbosity",
        return_value="high",
    )
    @patch(
        "code_muse.command_line.model_settings_menu.get_openai_reasoning_effort",
        return_value="medium",
    )
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
        return_value={},
    )
    @patch("code_muse.command_line.model_settings_menu.model_supports_setting")
...
class TestRenderMainList:
    ...
    @patch("code_muse.command_line.model_settings_menu.get_all_model_settings")
    ...
    @patch(
        "code_muse.command_line.model_settings_menu.model_supports_setting",
        return_value=False,
    )
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
...
class TestSaveCancel:
    @patch("code_muse.command_line.model_settings_menu.set_model_setting")
    @patch("code_muse.command_line.model_settings_menu.model_supports_setting")
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
        return_value={},
    ...
    @patch("code_muse.command_line.model_settings_menu.set_openai_reasoning_effort")
    @patch("code_muse.command_line.model_settings_menu.model_supports_setting")
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
        return_value={},
    ...
    @patch("code_muse.command_line.model_settings_menu.set_openai_verbosity")
    @patch("code_muse.command_line.model_settings_menu.model_supports_setting")
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
        return_value={},
...
class TestRunAndInteractive:
    ...
    @patch("code_muse.command_line.model_settings_menu.Application")
    @patch("sys.stdout")
    @patch("time.sleep")
    @patch(
        "code_muse.command_line.model_settings_menu._load_all_model_names",
    ...
    @patch("code_muse.command_line.model_settings_menu.ModelSettingsMenu")
...
class TestShowModelSettingsSummary:
    @patch("code_muse.command_line.model_settings_menu.emit_info")
    @patch(
        "code_muse.command_line.model_settings_menu.get_all_model_settings",
        return_value={},
    )
