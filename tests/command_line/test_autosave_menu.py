...
class TestGetSessionEntries:
    ...
    @patch("code_muse.command_line.autosave_menu.list_sessions")
    @patch("code_muse.command_line.autosave_menu._get_session_metadata")
...
class TestRenderPreviewPanel:
    ...
    @patch("code_muse.command_line.autosave_menu.load_session")
    @patch("code_muse.command_line.autosave_menu._extract_last_user_message")
...
class TestInteractiveAutosavePicker:
    ...
    @patch("code_muse.command_line.autosave_menu._get_session_entries")
    ...
    @patch("code_muse.command_line.autosave_menu._get_session_entries")
    @patch("code_muse.command_line.autosave_menu._render_menu_panel")
    @patch("code_muse.command_line.autosave_menu._render_preview_panel")
    ...
    async def test_application_setup_and_cleanup(
        ...
        with patch("code_muse.command_line.autosave_menu.Application") as mock_app:
    ...
    async def test_navigation_key_bindings(
        ...
        with patch("code_muse.command_line.autosave_menu.Application") as mock_app:
            ...
            with patch(
                "code_muse.command_line.autosave_menu.Application",
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_with_nonexistent_autosave_dir(self):
        ...
        with (
            patch(
                "code_muse.command_line.autosave_menu.AUTOSAVE_DIR",
                "/nonexistent/path",
            ),
            patch(
                "code_muse.command_line.autosave_menu.list_sessions",
    ...
    def test_with_permission_denied_access(self):
        ...
        with (
            patch(
                "code_muse.command_line.autosave_menu._get_session_metadata",
...
class TestBrowseModeNavigation:
    ...
    def test_browse_mode_down_navigation_logic(self):
        ...
        def move_down():
            if browse_mode[0] and message_idx[0] > 0:
                message_idx[0] -= 1
    ...
    def test_normal_mode_navigation_unchanged(self):
        ...
        def move_down_session():
            if not browse_mode[0] and selected_idx[0] < len(entries) - 1:
                selected_idx[0] += 1
