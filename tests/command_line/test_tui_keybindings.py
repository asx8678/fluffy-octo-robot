...
def test_colors_menu_keybindings():
    ...
    with (
        patch("code_muse.command_line.colors_menu.Application") as mock_app_cls,
        patch(
            "code_muse.command_line.colors_menu.FormattedTextControl",
...
def test_agent_menu_keybindings():
    ...
    with (
        ...
        patch(
            "code_muse.command_line.agent_menu._select_pinned_model",
            new_callable=AsyncMock,
            return_value=None,
        ),
        patch("code_muse.command_line.agent_menu.clone_agent", return_value=None),
        patch(
            "code_muse.command_line.agent_menu.is_clone_agent_name", return_value=True
        ),
        patch(
            "code_muse.command_line.agent_menu.delete_clone_agent", return_value=True
        ),
...
def test_autosave_menu_keybindings():
    ...
    with (
        ...
        patch(
            "code_muse.command_line.autosave_menu.load_session",
