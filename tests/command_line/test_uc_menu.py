...
from code_muse.command_line.uc_menu import (
    PAGE_SIZE,
    _get_tool_entries,
    _render_menu_panel,
...
class TestGetToolEntries:
    ...
    def test_empty_registry(self):
        ...
        with patch(
            "code_muse.command_line.uc_menu.get_registry",
...
class TestToggleToolEnabled:
    ...
    def test_toggle_enabled_to_disabled(self):
        ...
        try:
            ...
            with patch("code_muse.command_line.uc_menu.emit_success"):
...
class TestShowSourceCode:
    ...
    def test_shows_source_code(self):
        ...
        try:
            ...
            with patch("code_muse.command_line.uc_menu.emit_info") as mock_emit:
    ...
    def test_handles_read_error(self, mock_tool_enabled):
        ...
        with patch("code_muse.command_line.uc_menu.emit_error") as mock_error:
...
class TestHandleUcCommand:
    ...
    def test_launches_tui(self):
        ...
        with patch(
            "code_muse.command_line.uc_menu.interactive_uc_picker",
...
class TestInteractiveUcPicker:
    ...
    async def test_returns_none_when_cancelled(self):
        ...
        with (
            patch(
                "code_muse.command_line.uc_menu._get_tool_entries",
                return_value=[],
            ),
            patch(
                "code_muse.command_line.uc_menu.Application",
...
class TestPageSize:
    ...
    def test_source_page_size_exists(self):
        ...
        from code_muse.command_line.uc_menu import SOURCE_PAGE_SIZE
