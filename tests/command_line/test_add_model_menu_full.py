...
class TestPromptForCredentials:
    ...
    @patch("code_muse.command_line.add_model_menu.emit_info")
    ...
    @patch("code_muse.command_line.add_model_menu.safe_input", return_value="")
    ...
    @patch("code_muse.command_line.add_model_menu.emit_info")
    @patch("code_muse.command_line.add_model_menu.set_config_value")
    @patch(
        "code_muse.command_line.add_model_menu.safe_input", return_value="my-key-value"
    )
    ...
    @patch("code_muse.command_line.add_model_menu.emit_warning")
    @patch(
        "code_muse.command_line.add_model_menu.safe_input",
...
class TestAddModelMenuRun:
    ...
    @patch("code_muse.command_line.add_model_menu.emit_info")
    @patch("code_muse.command_line.add_model_menu.emit_error")
    @patch("code_muse.command_line.add_model_menu.set_awaiting_user_input")
    @patch("code_muse.command_line.add_model_menu.sys")
    @patch("code_muse.command_line.add_model_menu.Application")
    def test_run_unsupported(self, mock_app, mock_sys, mock_await, mock_err, mock_info):
        from code_muse.command_line.add_model_menu import UNSUPPORTED_PROVIDERS
    ...
    @patch("code_muse.command_line.add_model_menu.emit_info")
    @patch("code_muse.command_line.add_model_menu.emit_warning")
    @patch("code_muse.command_line.add_model_menu.safe_input", return_value="n")
...
class TestInteractiveModelPicker:
    @patch("code_muse.command_line.add_model_menu.AddModelMenu")
...
class TestPostTuiFlows:
    ...
    @patch("code_muse.command_line.add_model_menu.emit_info")
    @patch("code_muse.command_line.add_model_menu.safe_input")
