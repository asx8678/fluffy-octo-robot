...
def test_tutorial_chatgpt_flow() -> None:
    ...
    with patch("concurrent.futures.ThreadPoolExecutor") as mock_executor_class:
        ...
        with (
            patch(
                "code_muse.command_line.onboarding_wizard.reset_onboarding"
            ) as mock_reset,
            patch(
                "code_muse.plugins.chatgpt_oauth.oauth_flow.run_oauth_flow"
            ) as mock_oauth,
            patch(
                "code_muse.model_switching.set_model_and_reload_agent"
            ) as mock_set_model,
            patch("code_muse.command_line.core_commands.emit_info"),
        ):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch("code_muse.command_line.core_commands.emit_info"):
                        result = handle_tutorial_command("/tutorial")
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            "code_muse.command_line.core_commands.emit_info"
                        ) as mock_emit_info:
                            result = handle_tutorial_command("/tutorial")
