...
class TestGetAgentEntries:
    ...
    @patch("code_muse.command_line.agent_menu.get_agent_descriptions")
    @patch("code_muse.command_line.agent_menu.get_available_agents")
    ...
    def test_returns_single_agent(self, mock_available, mock_descriptions):
        ...
        mock_available.return_value = {"code_muse": "Muse"}
        mock_descriptions.return_value = {"code_muse": "A friendly coding assistant."}
...
class TestRenderMenuPanel:
    ...
    def test_renders_single_agent(self):
        ...
        """
        entries = [("code_muse", "Muse", "A friendly assistant.")]
    ...
    @patch("code_muse.command_line.agent_menu.get_agent_pinned_model")
...
class TestRenderPreviewPanel:
    ...
    def test_renders_agent_name(self):
        ...
        entry = ("code_muse", "Muse", "A friendly assistant.")

        result = _render_preview_panel(entry, current_agent_name="")

        text = _get_text_from_formatted(result)
        assert "Name:" in text
        assert "code_muse" in text
    ...
    def test_renders_description(self):
        ...
        entry = ("code_muse", "Muse", "A friendly coding assistant.")
    ...
    def test_renders_status_currently_active(self):
        ...
        result = _render_preview_panel(entry, current_agent_name="code_muse")
...
class TestGetAgentEntriesIntegration:
    ...
    def test_typical_usage_scenario(self, mock_available, mock_descriptions):
        ...
        mock_descriptions.return_value = {
            "code_muse": "A friendly AI coding assistant.",
...
class TestGetPinnedModelWithJSONAgents:
    ...
    @patch("code_muse.agents.json_agent.discover_json_agents")
    @patch("code_muse.command_line.agent_menu.get_agent_pinned_model")
    def test_returns_builtin_agent_pinned_model(self, mock_builtin, mock_json_agents):
        ...
        result = _get_pinned_model("code_muse")
    ...
    def test_builtin_takes_precedence_over_json(self, mock_builtin, mock_json_agents):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            json.dump({"name": "code_muse", "model": "claude-3-opus"}, f)
            json_file = f.name

        mock_json_agents.return_value = {"code_muse": json_file}
...
class TestApplyPinnedModelWithJSONAgents:
    ...
    def test_pins_builtin_agent(
        ...
        _apply_pinned_model("code_muse", "gpt-4")

        mock_set_pin.assert_called_once_with("code_muse", "gpt-4")
        mock_reload.assert_called_once_with("code_muse", "gpt-4")
    ...
    def test_unpins_builtin_agent(
        ...
        _apply_pinned_model("code_muse", "(unpin)")

        mock_clear_pin.assert_called_once_with("code_muse")
        mock_reload.assert_called_once_with("code_muse", None)
