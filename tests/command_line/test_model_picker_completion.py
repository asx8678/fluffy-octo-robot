...
class TestGetActiveModel:
    def test_returns_model_name(self):
        ...
        with patch(
            "code_muse.command_line.model_picker_completion.get_global_model_name",
            return_value="gpt-4",
        ):
...
class TestSetActiveModel:
    def test_delegates_to_set_model(self):
        from code_muse.command_line.model_picker_completion import set_active_model

        with patch(
            "code_muse.command_line.model_picker_completion.set_model_and_reload_agent"
        ) as mock_set:
...
class TestModelNameCompleter:
    ...
    def test_no_trigger(self):
        from code_muse.command_line.model_picker_completion import ModelNameCompleter
...
class TestModelSelectionMenu:
    ...
    def test_filter_keeps_current_model_selected_when_visible(self):
        from code_muse.command_line.model_picker_completion import ModelSelectionMenu
...
class TestGetInputWithModelCompletion:
    ...
    async def test_basic(self):
        ...
        with (
            ...
            patch(
                "code_muse.command_line.model_picker_completion.PromptSession"
            ) as mock_session_cls,
        ):
