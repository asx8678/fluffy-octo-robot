...
class TestPreviewDeleteSnippet:
    ...
    def test_exception_during_diff(self, tmp_path):
        ...
        f.write_text("hello world")
        with patch(
            "code_muse.plugins.file_permission_handler.register_callbacks.get_diff_context_lines",
    ...
    def test_lock_contention(self):
        ...
        try:
            with (
                ...
                patch(
                    "code_muse.plugins.file_permission_handler.register_callbacks.emit_warning"
                ),
            ):
                ok, fb = prompt_for_file_permission("f.txt", "edit")
                assert ok is False
...
class TestHandleEditFilePermission:
    def test_write(self):
        ...
        with (
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks._preview_write_to_file",
                return_value="diff",
            ),
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks.prompt_for_file_permission",
                return_value=(True, None),
            ),
        ):
            assert (
    ...
    def test_replace(self):
        ...
        with (
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks._preview_replace_in_file",
                return_value="diff",
            ),
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks.prompt_for_file_permission",
    ...
    def test_delete_snippet(self):
        ...
        with (
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks._preview_delete_snippet",
                return_value="diff",
            ),
            patch(
                "code_muse.plugins.file_permission_handler.register_callbacks.prompt_for_file_permission",
...
class TestGeneratePreviewFromOperationData:
    ...
    def test_exception_returns_none(self):
        ...
        with patch(
            "code_muse.plugins.file_permission_handler.register_callbacks._preview_delete_file",
