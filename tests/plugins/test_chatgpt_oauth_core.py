...
class TestTokenRefresh:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("code_muse.plugins.chatgpt_oauth.utils.refresh_access_token")
    @patch("code_muse.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("code_muse.plugins.chatgpt_oauth.utils.save_tokens")
    @patch("httpx.post")
    @patch("code_muse.plugins.chatgpt_oauth.utils.load_stored_tokens")
