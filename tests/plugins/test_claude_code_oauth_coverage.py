...
class TestStartCallbackServer:
    def test_all_ports_busy(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.CLAUDE_CODE_OAUTH_CONFIG",
                {"callback_port_range": [19000, 19001]},
            ),
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.HTTPServer",
                side_effect=OSError("port busy"),
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_error"),
        ):
    ...
    def test_success(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.assign_redirect_uri"
            ),
...
class TestAwaitCallback:
    def test_server_start_fails(self):
        ...
        ctx = MagicMock()
        with patch(
            "code_muse.plugins.claude_code_oauth.register_callbacks._start_callback_server",
            return_value=None,
        ):
    ...
    def test_timeout(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.build_authorization_url",
                return_value="http://auth.url",
            ),
            patch(
                "code_muse.tools.common.should_suppress_browser",
                return_value=True,
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_error"),
        ):
            assert _await_callback(ctx) is None
...
class TestPerformAuthentication:
    def test_no_code(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.prepare_oauth_context"
            ),
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks._await_callback",
                return_value=None,
            ),
        ):
    ...
    def test_token_exchange_fails(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.exchange_code_for_tokens",
                return_value=None,
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_error"),
    ...
    def test_save_fails(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.save_tokens",
                return_value=False,
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_error"),
    ...
    def test_no_access_token(self):
        ...
        with (
            ...
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.emit_success"
            ),
            patch(
    ...
    def test_no_models_returned(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.fetch_claude_code_models",
                return_value=[],
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch(
    ...
    def test_full_success(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.add_models_to_extra_config",
                return_value=True,
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch(
...
class TestHandleCustomCommand:
    ...
    def test_auth(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.load_stored_tokens",
                return_value={"access_token": "at"},
            ),
            patch(
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.set_model_and_reload_agent"
            ),
        ):
            assert (
    ...
    def test_status_authenticated(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.load_claude_models_filtered",
                return_value={
    ...
    def test_logout(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.get_token_storage_path",
                return_value=mock_path,
            ),
            patch(
                "code_muse.plugins.claude_code_oauth.register_callbacks.remove_claude_code_models",
                return_value=3,
            ),
            patch("code_muse.plugins.claude_code_oauth.register_callbacks.emit_info"),
            patch(
...
_MF = "code_muse.model_factory"
_CFG = "code_muse.config"
_HU = "code_muse.http_utils"
_CC = "code_muse.claude_cache_client"
_RC = "code_muse.plugins.claude_code_oauth.register_callbacks"
...
class TestAgentRunCallbacks:
    ...
    async def test_start_claude_model(self):
        ...
        with patch(
            "code_muse.plugins.claude_code_oauth.token_refresh_heartbeat.TokenRefreshHeartbeat",
    ...
    async def test_start_import_error(self):
        ...
        with patch.dict(
            "sys.modules",
            {"code_muse.plugins.claude_code_oauth.token_refresh_heartbeat": None},
        ):
