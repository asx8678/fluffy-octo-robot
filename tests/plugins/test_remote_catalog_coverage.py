...
from code_muse.plugins.agent_skills.remote_catalog import (
    RemoteCatalogData,
    _cache_is_fresh,
    _fetch_remote_json,
    _parse_catalog,
...
class TestCacheIsFresh:
    ...
    def test_exception(self):
        with patch(
            "code_muse.plugins.agent_skills.remote_catalog.Path.exists",
            side_effect=OSError,
        ):
...
class TestWriteCache:
    ...
    def test_failure(self):
        with patch(
            "code_muse.plugins.agent_skills.remote_catalog.Path.mkdir",
            side_effect=OSError,
        ):
...
class TestFetchRemoteJson:
    def test_success(self):
        ...
        with patch(
            "code_muse.plugins.agent_skills.remote_catalog.httpx.Client",
...
class TestParseCatalog:
    ...
    def test_exception(self):
        with patch(
            "code_muse.plugins.agent_skills.remote_catalog._safe_int",
...
class TestFetchRemoteCatalog:
    def test_fresh_cache(self, tmp_path):
        ...
        with (
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._cache_is_fresh",
                return_value=True,
            ),
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._read_cache",
                return_value=cache_data,
            ),
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._parse_catalog",
    ...
    def test_fresh_cache_read_fails(self):
        with (
            ...
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._fetch_remote_json",
                return_value={"version": "1", "groups": []},
            ),
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._write_cache",
                return_value=True,
            ),
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._parse_catalog",
    ...
    def test_stale_cache_remote_fails_fallback(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.agent_skills.remote_catalog._CACHE_PATH",
