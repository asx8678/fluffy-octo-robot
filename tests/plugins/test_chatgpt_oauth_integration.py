...
from code_muse.plugins.chatgpt_oauth import config
...
from code_muse.plugins.chatgpt_oauth.utils import (
...
class TestModelManagement:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.utils.get_chatgpt_models_path")
...
class TestCustomCommands:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.load_stored_tokens")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.emit_success")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.emit_info")
    def test_handle_chatgpt_status_authenticated(
        ...
        with patch(
            "code_muse.plugins.chatgpt_oauth.register_callbacks.load_chatgpt_models"
        ) as mock_models:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.load_stored_tokens")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.emit_warning")
    ...
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.remove_chatgpt_models")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.get_token_storage_path")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.emit_success")
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.emit_info")
    ...
    @patch("code_muse.plugins.chatgpt_oauth.register_callbacks.run_oauth_flow")
    @patch(
        "code_muse.plugins.chatgpt_oauth.register_callbacks.set_model_and_reload_agent"
    )
    ...
    def test_handle_custom_command_logout(self):
        ...
        with patch(
            "code_muse.plugins.chatgpt_oauth.register_callbacks.get_token_storage_path"
        ) as mock_path:
            mock_path.return_value = Mock(exists=Mock(return_value=False))
            with patch(
                "code_muse.plugins.chatgpt_oauth.register_callbacks.remove_chatgpt_models"
            ):
                with patch(
                    "code_muse.plugins.chatgpt_oauth.register_callbacks.emit_success"
                ):
...
class TestConfiguration:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.config.Path.mkdir")
    @patch("code_muse.plugins.chatgpt_oauth.config.Path.exists", return_value=False)
