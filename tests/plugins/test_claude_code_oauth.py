...
class TestTokenExchange:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.httpx.post")
...
class TestTokenRefresh:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.httpx.post")
    @patch("code_muse.plugins.claude_code_oauth.utils.load_stored_tokens")
    @patch("code_muse.plugins.claude_code_oauth.utils.save_tokens")
...
class TestValidAccessToken:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.refresh_access_token")
    @patch("code_muse.plugins.claude_code_oauth.utils.load_stored_tokens")
