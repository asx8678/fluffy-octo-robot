...
MOD = "code_muse.plugins.claude_code_oauth.register_callbacks"
...
class TestOAuthResult:
    def test_defaults(self):
        from code_muse.plugins.claude_code_oauth.register_callbacks import _OAuthResult
...
class TestAwaitCallback:
    ...
    @patch("code_muse.tools.common.should_suppress_browser", return_value=True)
    @patch(f"{MOD}.emit_error")
    ...
    @patch("code_muse.tools.common.should_suppress_browser", return_value=False)
    @patch(f"{MOD}.emit_error")
    @patch(f"{MOD}.emit_info")
...
class TestCustomHelpCommands:
    def test_custom_help_returns_commands(self):
        from code_muse.plugins.claude_code_oauth.register_callbacks import _custom_help
...
def _patch_model_deps():
    ...
    def _ctx():
        with (
            patch("code_muse.claude_cache_client.ClaudeCacheAsyncClient"),
            patch("code_muse.claude_cache_client.patch_anthropic_client_messages"),
...
class TestCreateClaudeCodeModel:
    ...
    @patch(
        "code_muse.model_factory.get_custom_config",
    ...
    @patch("code_muse.http_utils.get_cert_bundle_path", return_value="/ca.pem")
