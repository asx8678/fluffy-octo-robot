...
class TestTokenStorage:
    ...
    def test_save_stored_tokens_permission_error(self, mock_get_path):
        ...
        with patch(
            "code_muse.plugins.chatgpt_oauth.utils.atomic_write_private_json",
...
class TestAddModelsToConfig:
    ...
    @patch("code_muse.plugins.chatgpt_oauth.utils.save_chatgpt_models")
    @patch("code_muse.plugins.chatgpt_oauth.utils.load_chatgpt_models")
