...
class TestExampleCustomCommand:
    ...
    def _get_handler(self):
        from code_muse.plugins.example_custom_command.register_callbacks import (
...
class TestUniversalConstructorCallbacks:
    ...
    def test_startup_disabled(self):
        ...
        with patch(
            "code_muse.config.get_universal_constructor_enabled",
            return_value=False,
        ) as mock_enabled:
            _on_startup()
    ...
    def test_startup_enabled(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.universal_constructor.register_callbacks.get_registry",
                return_value=mock_registry,
            ),
            patch(
                "code_muse.plugins.universal_constructor.register_callbacks.USER_UC_DIR",
            ) as mock_dir,
        ):
            _on_startup()
