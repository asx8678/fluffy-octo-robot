...
class TestChatgptCustomHelp:
    def test_returns_entries(self):
        from code_muse.plugins.chatgpt_oauth.register_callbacks import _custom_help
...
class TestHandleChatgptLogout:
    def test_full_logout(self):
        ...
        with (
            ...
            patch(
                "code_muse.plugins.chatgpt_oauth.register_callbacks.CHATGPT_OAUTH_CONFIG",
...
class TestHandleCustomCommand:
    ...
    def test_status(self):
        ...
        with patch(
            "code_muse.plugins.chatgpt_oauth.register_callbacks._handle_chatgpt_status"
        ):
    ...
    def test_logout(self):
        ...
        with patch(
            "code_muse.plugins.chatgpt_oauth.register_callbacks._handle_chatgpt_logout"
        ):
...
class TestCreateChatgptOauthModel:
    ...
    def test_success(self):
        ...
        with (
            ...
            patch(
                "code_muse.http_utils.get_cert_bundle_path",
                return_value=None,
            ),
            patch("code_muse.chatgpt_codex_client.create_codex_async_client"),
