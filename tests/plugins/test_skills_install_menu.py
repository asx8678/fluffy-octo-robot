"""Tests for code_muse/plugins/agent_skills/skills_install_menu.py"""

from pathlib import Path
from unittest.mock import MagicMock, patch

_MOD = "code_muse.plugins.agent_skills.skills_install_menu"
...
class TestWrapText:
    def test_empty(self):
        from code_muse.plugins.agent_skills.skills_install_menu import _wrap_text
...
class TestCategoryKey:
    def test_normal(self):
        from code_muse.plugins.agent_skills.skills_install_menu import _category_key
...
def _make_entry(**kwargs):
    from code_muse.plugins.agent_skills.skill_catalog import SkillCatalogEntry
