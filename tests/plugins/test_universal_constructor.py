...
from code_muse.plugins.universal_constructor.registry import UCRegistry, get_registry
...
class TestInit:
    ...
    def test_user_uc_dir_under_code_muse(self):
        """Test that USER_UC_DIR is under .muse."""
        assert ".muse" in str(USER_UC_DIR)
...
class TestCallbackRegistration:
    ...
    def test_startup_callback_registered(self):
        ...
        from code_muse.plugins.universal_constructor.register_callbacks import (
            _on_startup,
        )
...
'''
            with (
                ...
                result = _handle_create_action(context, None, code, "A greeting tool")
...
class TestUniversalConstructorConfig:
    ...
    def test_get_uc_enabled_defaults_to_true(self):
        ...
        with patch("code_muse.config.get_value", return_value=None):
    ...
    def test_get_uc_enabled_returns_true_for_truthy_values(self):
        ...
        for val in truthy_values:
            with patch("code_muse.config.get_value", return_value=val):
                result = get_universal_constructor_enabled()
    ...
    def test_set_uc_enabled(self):
        ...
        from code_muse.config import set_universal_constructor_enabled

        with patch("code_muse.config.set_value") as mock_set:
