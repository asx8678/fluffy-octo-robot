...
class TestClaudeCodeConfigPaths:
    @patch("code_muse.plugins.claude_code_oauth.config.config")
...
class TestChatgptTestPlugin:
    ...
    def test_config_paths(self):
        from code_muse.plugins.chatgpt_oauth.test_plugin import test_config_paths

        test_config_paths()

    def test_oauth_config(self):
        from code_muse.plugins.chatgpt_oauth.test_plugin import test_oauth_config

        test_oauth_config()

    def test_jwt_parsing_with_nested_org(self):
        from code_muse.plugins.chatgpt_oauth.test_plugin import (
    ...
    def test_parse_jwt_claims(self):
        from code_muse.plugins.chatgpt_oauth.test_plugin import test_parse_jwt_claims
    ...
    def test_exchange_code_for_tokens(self):
        ...
        from code_muse.plugins.chatgpt_oauth import test_plugin
...
class TestClaudeCodeTestPlugin:
    ...
    def test_plugin_imports(self):
        from code_muse.plugins.claude_code_oauth.test_plugin import (
            test_plugin_imports,
        )
    ...
    def test_main_all_pass(self):
        from code_muse.plugins.claude_code_oauth.test_plugin import main
