...
class TestPrepareOAuthContext:
    ...
    def test_prepare_oauth_context_structure(self):
        ...
        with patch("code_muse.plugins.claude_code_oauth.utils._oauth_context", None):
    ...
    def test_prepare_oauth_context_caching(self):
        ...
        import code_muse.plugins.claude_code_oauth.utils as utils
...
class TestTokenStorage:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.get_token_storage_path")
...
class TestTokenValidity:
    ...
    def test_get_valid_access_token_refreshes(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.utils.load_stored_tokens",
                return_value=tokens,
            ),
            patch(
                "code_muse.plugins.claude_code_oauth.utils.refresh_access_token",
    ...
    def test_refresh_access_token_success(self, mock_post):
        ...
        with patch(
            ...
            with patch(
                "code_muse.plugins.claude_code_oauth.utils.save_tokens",
                return_value=True,
            ) as mock_save:
                with patch(
                    "code_muse.plugins.claude_code_oauth.utils.update_claude_code_model_tokens",
                    return_value=True,
                ):
...
class TestModelStorage:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.get_claude_models_path")
...
class TestAddModelsToConfig:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.save_claude_models")
    @patch("code_muse.plugins.claude_code_oauth.utils.get_valid_access_token")
...
class TestRemoveClaudeCodeModels:
    ...
    @patch("code_muse.plugins.claude_code_oauth.utils.save_claude_models")
    @patch("code_muse.plugins.claude_code_oauth.utils.load_claude_models")
...
class TestErrorHandling:
    ...
    def test_model_storage_permissions_and_errors(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.utils.get_claude_models_path",
    ...
    def test_token_storage_with_corrupted_json(self):
        ...
        with (
            patch(
                "code_muse.plugins.claude_code_oauth.utils.get_token_storage_path",
