...
class TestShellSafetyAgent:
    ...
    def test_agent_properties(self):
        ...
        with patch.dict(
            "sys.modules",
            {
                "code_muse.agents.base_agent": mock_base,
                "code_muse.agents": MagicMock(),
            },
        ):
            # Force reimport
            import importlib

            import code_muse.plugins.shell_safety.agent_shell_safety as mod
...
from code_muse.plugins.shell_safety.register_callbacks import (  # noqa: E402
    is_oauth_model,
)
...
from code_muse.plugins.agent_skills.discovery import discover_skills  # noqa: E402
...
class TestDiscoveryMissingLines:
    def test_discover_with_none_merges_defaults(self, tmp_path):
        ...
        with (
            patch(
                "code_muse.plugins.agent_skills.discovery.get_skill_directories",
                return_value=[str(configured_dir)],
            ),
            patch(
                "code_muse.plugins.agent_skills.discovery.get_default_skill_directories",
...
from code_muse.plugins.agent_skills.metadata import (  # noqa: E402
    get_skill_resources,
...
from code_muse.plugins.agent_skills.skill_catalog import (  # noqa: E402
    SkillCatalog,
...
class TestSkillCatalogMissing:
    ...
    def test_catalog_init_remote_exception(self):
        ...
        with patch(
            "code_muse.plugins.agent_skills.skill_catalog.fetch_remote_catalog",
...
class TestSkillsInstallMenuSizeFormat:
    def test_format_size_gb(self):
        ...
        from code_muse.plugins.agent_skills.skills_install_menu import _format_bytes
...
from code_muse.plugins.universal_constructor.registry import UCRegistry  # noqa: E402
...
from code_muse.plugins.universal_constructor.sandbox import (  # noqa: E402
    FunctionInfo,
    _extract_tool_meta,
    _find_main_function,
    _get_call_name,
