...
class TestConfig:
    ...
    def test_azure_cognitive_scope_constant(self):
        ...
        from code_muse.plugins.azure_foundry.config import AZURE_COGNITIVE_SCOPE
    ...
    def test_default_deployment_names(self):
        ...
        from code_muse.plugins.azure_foundry.config import DEFAULT_DEPLOYMENT_NAMES
    ...
    def test_default_context_lengths(self):
        ...
        from code_muse.plugins.azure_foundry.config import DEFAULT_CONTEXT_LENGTHS
    ...
    def test_get_foundry_resource_from_env(self):
        ...
        from code_muse.plugins.azure_foundry.config import get_foundry_resource
    ...
    def test_get_foundry_base_url_from_resource(self):
        ...
        from code_muse.plugins.azure_foundry.config import get_foundry_base_url
...
class TestAzureFoundryTokenProvider:
    ...
    def test_singleton_pattern(self):
        ...
        from code_muse.plugins.azure_foundry.token import (
            get_token_provider,
...
class TestResolveEnvVar:
    ...
    def test_resolve_env_var_with_dollar(self):
        ...
        from code_muse.plugins.azure_foundry.utils import resolve_env_var
...
class TestLoadSaveExtraModels:
    ...
    def test_load_extra_models_not_exists(self, tmp_path):
        ...
        from code_muse.plugins.azure_foundry.utils import load_extra_models

        with patch(
            "code_muse.plugins.azure_foundry.utils.get_extra_models_path",
    ...
    def test_save_extra_models_success(self, tmp_path):
        ...
        from code_muse.plugins.azure_foundry.utils import save_extra_models
...
class TestBuildFoundryModelConfig:
    ...
    def test_build_config_with_defaults(self):
        ...
        from code_muse.plugins.azure_foundry.utils import build_foundry_model_config
...
class TestParseContextWindowSuffix:
    ...
    def test_parse_1m_suffix(self):
        ...
        from code_muse.plugins.azure_foundry.utils import parse_context_window_suffix
...
class TestAddRemoveFoundryModels:
    ...
    def test_add_foundry_models(self, tmp_path):
        ...
        from code_muse.plugins.azure_foundry.utils import (
...
class TestSlashCommands:
    ...
    @patch("code_muse.plugins.azure_foundry.register_callbacks.get_token_provider")
    @patch("code_muse.plugins.azure_foundry.register_callbacks.get_foundry_resource")
    @patch(
        "code_muse.plugins.azure_foundry.register_callbacks.get_foundry_models_from_config"
    )
    @patch("code_muse.plugins.azure_foundry.register_callbacks.emit_info")
    @patch("code_muse.plugins.azure_foundry.register_callbacks.emit_success")
    def test_handle_foundry_status_authenticated(
        ...
        from code_muse.plugins.azure_foundry.register_callbacks import (
    ...
    @patch("code_muse.plugins.azure_foundry.register_callbacks.get_token_provider")
    @patch("code_muse.plugins.azure_foundry.register_callbacks.emit_warning")
    @patch("code_muse.plugins.azure_foundry.register_callbacks.emit_info")
    ...
    def test_handle_custom_command_status(self):
        ...
        with patch(
            "code_muse.plugins.azure_foundry.register_callbacks._handle_foundry_status"
        ) as mock_status:
    ...
    def test_handle_custom_command_setup(self):
        ...
        with patch(
            "code_muse.plugins.azure_foundry.register_callbacks._handle_foundry_setup"
        ) as mock_setup:
    ...
    def test_handle_custom_command_remove(self):
        ...
        with patch(
            "code_muse.plugins.azure_foundry.register_callbacks._handle_foundry_remove"
        ) as mock_remove:
    ...
    def test_custom_help_entries(self):
        ...
        from code_muse.plugins.azure_foundry.register_callbacks import _custom_help
...
class TestCreateAzureFoundryModel:
    ...
    def test_create_model_no_resource(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch(
                "code_muse.plugins.azure_foundry.register_callbacks.emit_warning"
            ) as mock_warn:
    ...
    def test_create_model_auth_failed(self):
        ...
        with (
            patch(
                "code_muse.plugins.azure_foundry.register_callbacks.get_token_provider",
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            "code_muse.provider_identity.resolve_provider_identity",
                            return_value="identity",
                        ):
                            with patch(
                                "code_muse.provider_identity.make_anthropic_provider",
                                return_value=Mock(),
                            ):
                                with patch(
...
class TestPluginCallbackRegistration:
    ...
    def test_callbacks_registered(self):
        ...
        import code_muse.plugins.azure_foundry.register_callbacks  # noqa: F401
        from code_muse.callbacks import get_callbacks
...
class TestDiscovery:
    ...
    def test_azure_account_dataclass(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import AzureAccount
    ...
    def test_azure_deployment_dataclass(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import AzureDeployment
    ...
    def test_get_management_token_failure(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import _get_management_token
    ...
    def test_management_get_success(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import _management_get
    ...
    def test_find_account_success(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import find_account
    ...
    def test_list_deployments_success(self):
        ...
        from code_muse.plugins.azure_foundry.discovery import (
            AzureAccount,
            list_deployments,
        )
...
class TestCreateAzureFoundryOpenAIModel:
    ...
    def test_create_model_no_deployment_name(self):
        ...
        with patch("code_muse.plugins.azure_foundry.register_callbacks.emit_warning"):
            result = _create_azure_foundry_openai_model(
    ...
    def test_create_model_success(self):
        ...
        with (
            ...
            patch(
                "code_muse.provider_identity.make_openai_provider",
                return_value=Mock(),
            ),
            patch(
            ...
            patch("pydantic_ai.models.openai.OpenAIChatModel") as mock_chat_model,
        ):
            result = _create_azure_foundry_openai_model(
                "foundry-gpt",
                {
            ...
            assert (
                call_kwargs["azure_endpoint"] == "https://my-resource.openai.azure.com"
            )
