...
from code_muse.plugins.plugin_trust.register_callbacks import (
...
def fresh_manifest(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("MUSE_PLUGIN_TRUST_MANIFEST", str(manifest_path))
...
class TestPluginList:
    ...
    def test_no_user_plugins_dir(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "code_muse.plugins.plugin_trust.register_callbacks.get_user_plugins_dir",
            lambda: fake_dir,
        )
        result = _plugin_list()
...
class TestPluginTrust:
    ...
    def test_trust_warns_when_plugins_already_loaded(
        ...
        import code_muse.plugins.plugin_trust.register_callbacks as trust_mod
...
class TestManifestPermissions:
    ...
    def test_manifest_file_is_0o600(self, fresh_manifest):
        from code_muse.plugins import record_plugin_trust
    ...
    def test_user_plugins_dir_is_0o700(self, tmp_path, monkeypatch):
        ...
        from code_muse.plugins import ensure_user_plugins_dir
