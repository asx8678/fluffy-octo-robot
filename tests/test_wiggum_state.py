...
class TestWiggumState:
    ...
    def setup_method(self):
        ...
        from code_muse.command_line.wiggum_state import stop_wiggum
    ...
    def test_get_wiggum_state_singleton(self):
        ...
        from code_muse.command_line.wiggum_state import get_wiggum_state
...
class TestWiggumCommand:
    ...
    def test_wiggum_stop_command_when_active(self):
        ...
        from code_muse.command_line.command_registry import get_command
        from code_muse.command_line.wiggum_state import is_wiggum_active, start_wiggum
