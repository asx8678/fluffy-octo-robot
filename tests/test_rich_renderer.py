...
MESSAGING_PATH = ROOT / "code_muse" / "messaging"
TOOLS_PATH = ROOT / "code_muse" / "tools"

messaging_pkg = types.ModuleType("code_muse.messaging")
messaging_pkg.__path__ = [str(MESSAGING_PATH)]
sys.modules.setdefault("code_muse.messaging", messaging_pkg)

tools_pkg = types.ModuleType("code_muse.tools")
tools_pkg.__path__ = [str(TOOLS_PATH)]
sys.modules.setdefault("code_muse.tools", tools_pkg)

common_stub = types.ModuleType("code_muse.tools.common")
common_stub.format_diff_with_colors = lambda diff_text: diff_text
sys.modules.setdefault("code_muse.tools.common", common_stub)

from code_muse.messaging import rich_renderer as rich_renderer_module  # noqa: E402
from code_muse.messaging.bus import MessageBus  # noqa: E402
from code_muse.messaging.messages import (  # noqa: E402
...
from code_muse.messaging.rich_renderer import RichConsoleRenderer  # noqa: E402
