"""Tests for code_muse.agents._history — pure helper functions.
...
class TestEstimateTokens:
    ...
    def test_large_text_formula(self):
        text = "x" * 250
        # 250 / 3.0 = 83
        assert estimate_tokens(text) == 83

    @pytest.mark.parametrize(
        "length,expected", [(1, 1), (2, 1), (3, 1), (4, 1), (5, 1), (6, 2), (10, 3)]
    )
