...
This test uses a custom HTTP/HTTPS proxy to monitor all requests made by Muse
...
def test_network_traffic_on_simple_message(
    ...
    3. Spawns Muse in interactive mode
    ...
    try:
        ...
        print(f"\n[Run] Proxy started at {proxy_url}")
        ...
        test_env["MUSE_DISABLE_RETRY_TRANSPORT"] = "true"
