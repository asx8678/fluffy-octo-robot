...
from code_muse.model_factory import ModelFactory, get_custom_config
...
class TestModelFactoryErrors:
    ...
    def test_missing_bundled_models_file(self):
        ...
        from code_muse.model_factory import invalidate_models_config_cache
    ...
    def test_load_config_general_exception_handling(self):
        ...
        try:
            with patch("code_muse.config.EXTRA_MODELS_FILE", bad_extra):
    ...
    def test_config_callback_exception_handling(self):
        ...
        with (
            ...
            pytest.raises(Exception, match="Callback error"),
        ):
            ModelFactory.load_config()
