...
class TestAutoSaveSessionFunctionality:
    @patch("code_muse.config.get_auto_save_session")
    ...
    @patch("code_muse.config.save_session")
    @patch("code_muse.config.get_current_autosave_session_name")
    @patch("code_muse.config.datetime.datetime")
    @patch("code_muse.config.get_auto_save_session")
...
class TestFinalizeAutoSaveSession:
    @patch("code_muse.config.rotate_autosave_id", return_value="fresh_id")
    @patch("code_muse.config.auto_save_session_if_enabled", return_value=True)
    ...
    @patch("code_muse.config.rotate_autosave_id", return_value="fresh_id")
    @patch("code_muse.config.auto_save_session_if_enabled", return_value=False)
